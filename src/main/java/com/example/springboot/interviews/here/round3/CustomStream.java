...
public class CustomStream {
    public static void main(String[] args) {
        ...
        employeeList.addAll(List.of(new Employee(1,"virendra",1000,"IT"),new Employee(2,"Dhirendra",1000,"sales"),new Employee(3,"Ankit",3000,"Dev"),new Employee(4,"yagya",50000,"IT"),new Employee(6,"Nitesh",24000,"sales")));
